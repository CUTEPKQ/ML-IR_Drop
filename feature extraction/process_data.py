...
class ArgParaser(object):
    def __init__(self) -> None:
        ...
        self.parser.add_argument('--save_path', default='../../out_1128', help='save path')
        self.parser.add_argument('--process_capacity', default=30, help='number of process for multi process')
