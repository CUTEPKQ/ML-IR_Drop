...
feature_path = './training_set/1128/feature'
label_path = './training_set/1128/label'

out_train_csv = './train.csv'
out_test_csv = './test.csv'

split_ratio = 0.9  # 0.7 train 0.3 test
    ...
    with open(out_train_csv, 'w') as f_train:
        with open(out_test_csv, 'w') as f_test:
            ...
            for i, features_name in enumerate(features):
                features_path = 'training_set/1128/feature/{}'.format(features_name)
                labels_path = 'training_set/1128/label/{}'.format(features_name)
                instance_count_path = 'out_1128/features/instance_count/{}'.format(features_name)
                instance_IR_drop_path = 'out_1128/features/instance_IR_drop/{}'.format(features_name)
