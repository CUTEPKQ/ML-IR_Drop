...
class Parser(object):
    def __init__(self) -> None:
        ...
        self.parser.add_argument('--save_path', default='work_dir/1128/', help='Save path.')
        ...
        self.parser.add_argument('--dataroot', default='../..', help='Path to data')
        ...
        self.parser.add_argument('--in_channels', default=3, help='Model parameters, input channels.')
        ...
        self.parser.add_argument('--final_test', type=bool,default=False, help='prevent using static_ir to mimic the final environment.')
